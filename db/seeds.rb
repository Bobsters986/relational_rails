...
artist_4 = Artist.create!(full_band: false, cost: 60, name: "Pretty Lights", venue: venue_1)

artist_5 = Artist.create!(full_band: true, cost: 65, name: "The String Cheese Incident", venue: venue_2)
artist_6 = Artist.create!(full_band: false, cost: 55, name: "Emancipator", venue: venue_2)
artist_7 = Artist.create!(full_band: true, cost: 60, name: "Billy Strings", venue: venue_2)
